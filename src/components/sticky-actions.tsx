  ...
  return (
    ...
    >
      <a
        ...
        className="sticky-contact-call group relative inline-flex min-h-10 items-center justify-center gap-2 overflow-visible rounded-full bg-[#E51B23] px-3 text-sm font-black text-white shadow-lg shadow-red-950/20 ring-1 ring-white/50 transition hover:-translate-y-0.5 hover:bg-[#C9151C] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#FFD447] sm:size-12 sm:p-0 sm:shadow-xl sm:shadow-red-950/25 sm:ring-4 sm:ring-white/90"
      ...
      >
        ...
        <PhoneCall className="relative size-5" weight="duotone" aria-hidden="true" />
      ...
      >
        ...
        <FaWhatsapp className="relative size-6" aria-hidden="true" />
